...
export default function Example() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
        const response = await axios.post('http://localhost:8099/api/utilisateurs/createUser', {
        firstName,
        lastName,   
        email,
        password,
    ...
    return (
      ...
      <Avatar sx={{ m: 1, bgcolor: 'secondary.main', width: 45, height: 45  }}>
        <LockOutlinedIcon />
          ...
          <form onSubmit={handleSubmit}  className="mx-auto mt-16 max-w-xl sm:mt-1">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            <label htmlFor="firstname" className="block text-sm font-semibold leading-5 text-gray-900" >
              First name
            </label>
          ...
          <div>
            <label htmlFor="lastname" className="block text-sm font-semibold leading-5 text-gray-900">
              Last name
            </label>
            <div className="mt-2.5">
          ...
          <div className="sm:col-span-2">
            <label htmlFor="Password" className="block text-sm font-semibold leading-5 text-gray-900">
              Password
            </label>
            <div className="mt-2.5">
        ...
        <div className="mt-3 flex justify-center">
          <button className="button flex w-full justify-center px-3 py-2 text-m" > Sign Up </button>
        </div>
      </form>
        ...
        <div className="fixed bottom-4 left-4 z-50">
          <div className="max-w-sm w-full bg-purple-200 shadow-md rounded-lg overflow-hidden">
            <div className="p-3">
              <div className="flex items-center">
                ...
                <p className="text-sm leading-tight text-white-800">Account Created Successfully </p>
              </div>
            </div>
          </div>
        </div>
          ...
          <footer className="p-4   dark:bg-gray-800 mt-1">
